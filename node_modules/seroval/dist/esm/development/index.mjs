...
function isIterable(ctx, value) {
  ...
  if (ctx.features & 2048 /* TypedArray */) {
    switch (currentClass) {
      case Int8Array:
      case Int16Array:
      case Int32Array:
  ...
  if (ctx.features & 32 /* Map */ && currentClass === Map) {
    return false;
  }
  if (ctx.features & 512 /* Set */ && currentClass === Set) {
    return false;
  }
  if (ctx.features & 8192 /* WebAPI */) {
...
async function generateRequestNode(ctx, id, current) {
  return {
    t: 35 /* Request */,
    i: id,
...
async function generateResponseNode(ctx, id, current) {
  return {
    t: 36 /* Response */,
    i: id,
    s: void 0,
    ...
    f: void 0,
    a: [
      current.body ? serializeArrayBuffer(ctx, await current.clone().arrayBuffer()) : NULL_NODE,
...
async function generateEventNode(ctx, id, current) {
  return {
    t: 37 /* Event */,
    i: id,
...
async function generateCustomEventNode(ctx, id, current) {
  return {
    t: 38 /* CustomEvent */,
    i: id,
    s: serializeString(current.type),
...
async function parseObject(ctx, current) {
  ...
  if (ctx.features & 256 /* Promise */ && (currentClass === Promise || current instanceof Promise)) {
  ...
  if (ctx.features & 8192 /* WebAPI */) {
    ...
    if (typeof Request !== "undefined" && currentClass === Request) {
      return generateRequestNode(ctx, id, current);
    }
    if (typeof Response !== "undefined" && currentClass === Response) {
      return generateResponseNode(ctx, id, current);
    }
    if (typeof Event !== "undefined" && currentClass === Event) {
      return generateEventNode(ctx, id, current);
    }
    if (typeof CustomEvent !== "undefined" && currentClass === CustomEvent) {
      return generateCustomEventNode(ctx, id, current);
    }
    if (typeof DOMException !== "undefined" && currentClass === DOMException) {
      return createDOMExceptionNode(id, current);
    }
  }
  if (ctx.features & 1 /* AggregateError */ && typeof AggregateError !== "undefined" && (currentClass === AggregateError || current instanceof AggregateError)) {
    return generateAggregateErrorNode(ctx, id, current);
  }
  if (current instanceof Error) {
    return generateErrorNode(ctx, id, current);
  }
  if (ctx.features & 1024 /* Symbol */ && Symbol.iterator in current) {
...
async function parseAsync(ctx, current) {
  ...
  if (ctx.features & 8 /* BigInt */ && t === "bigint") {
...
function deserializeRequest(ctx, node) {
  return assignIndexedValue(
    ctx,
    node.i,
    new Request(deserializeString(node.s), deserializeTree(ctx, node.f))
  );
}
function deserializeResponse(ctx, node) {
  return assignIndexedValue(
    ctx,
    node.i,
    new Response(
      deserializeTree(ctx, node.a[0]),
      deserializeTree(ctx, node.a[1])
    )
  );
}
function deserializeEvent(ctx, node) {
  return assignIndexedValue(
    ctx,
    node.i,
    new Event(
      deserializeString(node.s),
      deserializeTree(ctx, node.f)
    )
  );
}
function deserializeCustomEvent(ctx, node) {
  return assignIndexedValue(
    ctx,
    node.i,
    new CustomEvent(
...
function deserializeDOMException(ctx, node) {
  return assignIndexedValue(
    ctx,
    node.i,
    new DOMException(
...
function serializeRequest(ctx, node) {
  return assignIndexedValue2(ctx, node.i, 'new Request("' + node.s + '",' + serializeTree(ctx, node.f) + ")");
}
function serializeResponse(ctx, node) {
  return assignIndexedValue2(ctx, node.i, "new Response(" + serializeTree(ctx, node.a[0]) + "," + serializeTree(ctx, node.a[1]) + ")");
}
function serializeEvent(ctx, node) {
  return assignIndexedValue2(
    ctx,
    node.i,
...
function serializeCustomEvent(ctx, node) {
  return assignIndexedValue2(
    ctx,
    node.i,
...
function serializeDOMException(ctx, node) {
  return assignIndexedValue2(
    ctx,
    node.i,
...
function generateEventNode2(ctx, id, current) {
  return {
    t: 37 /* Event */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: parseObject2(ctx, createEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
function generateCustomEventNode2(ctx, id, current) {
  return {
    t: 38 /* CustomEvent */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: parseObject2(ctx, createCustomEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
function parseObject2(ctx, current) {
  ...
  if (ctx.features & 8192 /* WebAPI */) {
    ...
    if (typeof Event !== "undefined" && currentClass === Event) {
      return generateEventNode2(ctx, id, current);
    }
    if (typeof CustomEvent !== "undefined" && currentClass === CustomEvent) {
      return generateCustomEventNode2(ctx, id, current);
    }
    if (typeof DOMException !== "undefined" && currentClass === DOMException) {
      return createDOMExceptionNode(id, current);
    }
  ...
  if (ctx.features & 1024 /* Symbol */ && Symbol.iterator in current) {
    return generateObjectNode2(ctx, id, current, !!currentClass);
  }
  throw new UnsupportedTypeError(current);
}
...
function createSymbolNode2(ctx, current) {
  ...
  return createWKSymbolNode(newID, current);
}
...
async function generateRequestNode2(ctx, id, current) {
  return {
    t: 35 /* Request */,
    i: id,
    s: serializeString(current.url),
...
async function generateResponseNode2(ctx, id, current) {
  return {
    t: 36 /* Response */,
    i: id,
    s: void 0,
    ...
    f: void 0,
    a: [
      current.body ? serializeArrayBuffer3(ctx, await current.clone().arrayBuffer()) : NULL_NODE,
      await parseObject3(ctx, createResponseOptions(current))
    ],
    b: void 0,
    o: void 0
  };
}
async function generateEventNode3(ctx, id, current) {
  return {
    t: 37 /* Event */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: await parseObject3(ctx, createEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
async function generateCustomEventNode3(ctx, id, current) {
  return {
    t: 38 /* CustomEvent */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: await parseObject3(ctx, createCustomEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
async function parseObject3(ctx, current) {
  ...
  if (ctx.features & 8192 /* WebAPI */) {
    ...
    if (typeof Request !== "undefined" && currentClass === Request) {
      return generateRequestNode2(ctx, id, current);
    }
    if (typeof Response !== "undefined" && currentClass === Response) {
      return generateResponseNode2(ctx, id, current);
    }
    if (typeof Event !== "undefined" && currentClass === Event) {
      return generateEventNode3(ctx, id, current);
    }
    if (typeof CustomEvent !== "undefined" && currentClass === CustomEvent) {
      return generateCustomEventNode3(ctx, id, current);
    }
    if (typeof DOMException !== "undefined" && currentClass === DOMException) {
      return createDOMExceptionNode(id, current);
    }
  ...
  if (ctx.features & 1024 /* Symbol */ && Symbol.iterator in current) {
    return generateObjectNode3(ctx, id, current, !!currentClass);
  }
  throw new UnsupportedTypeError(current);
}
...
function serializeRequest2(ctx, node) {
  return assignIndexedValue3(node.i, 'new Request("' + node.s + '",' + crossSerializeTree(ctx, node.f) + ")");
}
function serializeResponse2(ctx, node) {
  return assignIndexedValue3(
    node.i,
    "new Response(" + crossSerializeTree(ctx, node.a[0]) + "," + crossSerializeTree(ctx, node.a[1]) + ")"
  );
}
function serializeEvent2(ctx, node) {
  return assignIndexedValue3(
    node.i,
    'new Event("' + node.s + '",' + crossSerializeTree(ctx, node.f) + ")"
  );
}
function serializeCustomEvent2(ctx, node) {
  return assignIndexedValue3(
    node.i,
    'new CustomEvent("' + node.s + '",' + crossSerializeTree(ctx, node.f) + ")"
  );
}
function serializeDOMException2(node) {
  return assignIndexedValue3(
    node.i,
    'new DOMException("' + node.s + '","' + node.c + '")'
  );
...
function crossSerializeTree(ctx, node) {
  switch (node.t) {
    ...
    case 35 /* Request */:
      return serializeRequest2(ctx, node);
    case 36 /* Response */:
      return serializeResponse2(ctx, node);
    case 37 /* Event */:
      return serializeEvent2(ctx, node);
    case 38 /* CustomEvent */:
      return serializeCustomEvent2(ctx, node);
    case 39 /* DOMException */:
      return serializeDOMException2(node);
    default:
      throw new Error("invariant");
  }
}
...
function pushReadableStreamState(ctx, id, reader) {
  reader.read().then(
    (data) => {
      if (ctx.alive) {
        if (data.done) {
...
function generateRequestNode3(ctx, id, current) {
  return {
    t: 35 /* Request */,
    i: id,
    s: serializeString(current.url),
...
function generateResponseNode3(ctx, id, current) {
  return {
    t: 36 /* Response */,
    i: id,
    s: void 0,
    ...
    f: void 0,
    a: [
      current.body ? parseObject4(ctx, current.clone().body) : NULL_NODE,
      parseObject4(ctx, createResponseOptions(current))
    ],
    b: void 0,
    o: void 0
  };
}
function generateEventNode4(ctx, id, current) {
  return {
    t: 37 /* Event */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: parseObject4(ctx, createEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
function generateCustomEventNode4(ctx, id, current) {
  return {
    t: 38 /* CustomEvent */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: parseObject4(ctx, createCustomEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
function parseObject4(ctx, current) {
  ...
  if (ctx.features & 32 /* Map */ && currentClass === Map) {
    return generateMapNode4(ctx, id, current);
  }
  if (ctx.features & 512 /* Set */ && currentClass === Set) {
    return generateSetNode4(ctx, id, current);
  }
  if (ctx.features & 256 /* Promise */ && (currentClass === Promise || current instanceof Promise)) {
  ...
  if (ctx.features & 8192 /* WebAPI */) {
    ...
    if (typeof Request !== "undefined" && currentClass === Request) {
      return generateRequestNode3(ctx, id, current);
    }
    if (typeof Response !== "undefined" && currentClass === Response) {
      return generateResponseNode3(ctx, id, current);
    }
    if (typeof Event !== "undefined" && currentClass === Event) {
      return generateEventNode4(ctx, id, current);
    }
    if (typeof CustomEvent !== "undefined" && currentClass === CustomEvent) {
      return generateCustomEventNode4(ctx, id, current);
    }
    if (typeof DOMException !== "undefined" && currentClass === DOMException) {
      return createDOMExceptionNode(id, current);
    }
  ...
  if (ctx.features & 1024 /* Symbol */ && Symbol.iterator in current) {
    return generateObjectNode4(ctx, id, current, !!currentClass);
  }
  throw new UnsupportedTypeError(current);
}
...
function generateEventNode5(ctx, id, current) {
  return {
    t: 37 /* Event */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: parseObject5(ctx, createEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
function generateCustomEventNode5(ctx, id, current) {
  return {
    t: 38 /* CustomEvent */,
    i: id,
    s: serializeString(current.type),
    ...
    e: void 0,
    a: void 0,
    f: parseObject5(ctx, createCustomEventOptions(current)),
    b: void 0,
    o: void 0
  };
}
function parseObject5(ctx, current) {
  ...
  if (ctx.features & 8192 /* WebAPI */) {
    ...
    if (typeof Event !== "undefined" && currentClass === Event) {
      return generateEventNode5(ctx, id, current);
    }
    if (typeof CustomEvent !== "undefined" && currentClass === CustomEvent) {
      return generateCustomEventNode5(ctx, id, current);
    }
    if (typeof DOMException !== "undefined" && currentClass === DOMException) {
      return createDOMExceptionNode(id, current);
    }
  ...
  if (ctx.features & 1024 /* Symbol */ && Symbol.iterator in current) {
    return generateObjectNode5(ctx, id, current, !!currentClass);
  }
  throw new UnsupportedTypeError(current);
}
