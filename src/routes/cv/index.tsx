      ...
      <div class="flex-row">
        <div class="box left-box">
          ...
          <p>
            ...
            Aug 2023 to Present<br/>
            National University of Singapore<br/>
            <strong>Advisor</strong>: Asst. Prof. Michael D. <strong>ADAMS</strong>
          </p>
          <p>
            <strong>M.Sc. in Computer Science (by Research)</strong> <br /> 
            Jan 2021 to Jun 2023<br/>
            National University of Singapore<br/>
            <strong>Advisor</strong>: Assoc. Prof. <strong>KHOO</strong> Siau Cheng
          </p>
          <p>
            <strong>B.Eng. (Hons) in Industrial & Systems Engineering</strong> <br /> 
            Aug 2017 to Dec 2020<br/>
            National University of Singapore<br/>
            <strong>Advisor</strong>: Prof. Andrew <strong>LIM</strong>
          </p>
        </div>
        <div class="box">
          <h2>Employment</h2>
          ...
          <p>
            ...
            Aug 2018 to Dec 2022<br/>
            <strong>National University of Singapore</strong><br/>
            Lecturer for IT5001<br/>
            Tutor for CS1010E, CS2030, CS20230S, IT5001, IT5003, IT5004

          </p>
          <p>
            <strong>PWA Developer</strong><br/> 
            Aug 2019 to Aug 2020<br/>
            <strong>National University of Singapore</strong><br/>
          ...
          <p>
            ...
            May 2018 to Jul 2020<br/>
            <strong>Sqkii</strong><br/>
            Pitched projects to prospective clients

          </p>
          <p>
            <strong>Co-Founder, President</strong><br/> 
            Apr 2018 to Apr 2020<br/>
            <strong>Uncage</strong> (no longer in service)<br/>
      ...
      <div class="flex-row">
        <div class="box left-box">
          ...
          <p>
            ...
            Jan 2021 to Jun 2023<br/>
            National University of Singapore<br/>
            <strong>Advisor</strong>: Assoc. Prof. <strong>KHOO</strong> Siau Cheng<br/>
          ...
          <p>
            <strong>Regional Multi-Person Pose Estimation for Sports Analytics</strong> <br /> 
            Aug 2020 to Dec 2020<br/>
            National University of Singapore<br/>
            <strong>Advisor</strong>: Prof. Andrew <strong>LIM</strong><br/>
            Used AlphaPose and a novel LSTM network for Action Recognition in
            Basketball analysis
          </p>
          <p>
            <strong>Fedora-SoC</strong> <br /> 
            Aug 2020 to Dec 2020<br/>
            National University of Singapore<br/>
            <strong>Advisor</strong>: Dr. Henry <strong>CHIA</strong><br/>
            Developed a fork of Fedora (Linux Workstation) for exam-takers in NUS SoC during COVID-19 pandemic
          </p>
          <p>
            <strong>NUS Smart Dining</strong> <br /> 
            Aug 2019 to May 2020<br/>
            National University of Singapore<br/>
          ...
          <p>
            <strong>Live Firing Systems Optimization</strong> <br /> 
            Feb 2017<br/>
        ...
        <div class="box">
          ...
          <p>
            <strong>Honour List of Student Tutors</strong><br/> 
            May 2021<br/>
            <strong>National University of Singapore</strong><br/>
          </p>
          <p>
          ...
          <p>
            <strong>3AMB Base Sergeant Major's Coin</strong><br/> 
            Nov 2016<br/>
            <strong>Singapore Armed Forces</strong><br/>
          </p>
          <p>
            <strong>Letter of Commendation</strong><br/> 
            Oct 2016<br/>
            <strong>Singapore Armed Forces</strong><br/>
          </p>
          <p>
            <strong>3AMB Commanding Officer's Coin</strong><br/> 
            Sep 2016<br/>
            <strong>Singapore Armed Forces</strong><br/>
          </p>
          <p>
            <strong>SCS L Coy Platoon Best Soldier</strong><br/> 
            Sep 2015<br/>
            <strong>Singapore Armed Forces</strong><br/>
          </p>
          <p>
            <strong>BMTC 2 Coy Platoon Best Recruit</strong><br/> 
            Jul 2015<br/>
            <strong>Singapore Armed Forces</strong><br/>
          </p>
        </div>
      ...
      <div class="box solo">
        ...
        <p>
          ...
          Java, Python, Scala, C/C++, JavaScript, TypeScript, Solid.js,
            Nuxt.js, Vue.js, React.js, Quasar, Node.js, ML, Haskell, Lean, Rust, Go,
